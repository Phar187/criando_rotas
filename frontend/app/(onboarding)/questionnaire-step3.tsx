...
const COLORS = {
  ...
  primary: "#412d9eff",      // Roxo Vibrante para Ações
...
// O nome da função foi alterado para Step3 para refletir o passo do questionário
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
      <View style={styles.container}>
        ...
        <Text style={styles.question}>
          Gostaria que usassemos suas informações para personalizar a experiência?
        </Text>
        ...
        <TouchableOpacity
          ...
          disabled={!selected}
          // Note: O roteamento final leva para a tela principal (tabs)
